...
Метод Монте-Карло є потужним інструментом для чисельного обчислення інтегралів і моделювання складних випадкових процесів.
Під час виконання завдання було реалізовано симуляцію кидання гральних кубиків для оцінки ймовірності певних подій, а також наближене обчислення площі під кривою (інтеграла) за допомогою випадкових точок.

Отримані результати показали, що зі збільшенням кількості випадкових спроб точність оцінки значно зростає, наближаючись до аналітичного значення інтеграла. Це підтверджує ефективність і стабільність методу Монте-Карло для задач статистичного моделювання, навіть за обмежених обчислювальних ресурсів.
